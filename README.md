...
| `@jpisgeek/caddy`                 | `2026.09.04.1` | [`caddy/`](caddy/)                                 | Manage individual routes in an existing systemd Caddy wildcard site through Swamp SSH, with drift checks, validation, private backups and rollback.   |
